...
def main():
    ...
    executable_path = os.path.join(base_dir, "../bin/openvt-persistentrandomwalk-model005-tst")
    ...
    for sim_id in range(num_sims):
        ...
        try:
            subprocess.run(
                [executable_path, "openvt-persistentrandomwalk-model005.par", str(sim_id), "--platform minimal"], # argv[1] = parameterfile, argv[2] = id
                check=True
            )
